This is an alx team project on simple shell by Tinsae Tadese AFR-1021  and Adebayo Olajide AFR-1021
...
Output Unless specified otherwise, your program must have the exact same output as sh (/bin/sh) as well as the exact same error output. The only difference is when you print an error, the name of the program must be equivalent to your argv[0] (See below) Example of error with sh:
...
The shell will be compiled using: gcc -Wall -Werror -Wextra -pedantic -std=gnu89 *.c -o hsh

Testing

While testing, the shell should work in both interactive and non-interactive mode.

Task

The project consists of 8 mandatory tasks and 15 advanced tasks.
